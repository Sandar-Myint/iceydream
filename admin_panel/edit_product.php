...
<head>
	...
	<title>Ice Cream Delighs - Edit Product</title>
			...
			<div class="box-container">
				...
				<div class="form-container">
					<form action="" method="post" enctype="multipart/form-data" class="register">
						...
						<input type="hidden" name="produd_id" value="<?= $fetch_product['id']; ?>">
						...
						<div class="input-field">
							...
							<textarea name="description" value="<?= $fetch_product['product_detail']; ?>" class="box"></textarea>

						<div class="input-field">
							<p>product stock<span>*</span></p>
							<input type="number" value="<?= $fetch_product['stock']; ?>" class="box">
						</div>
						...
						<div class="flex-btn">
							...
							<input type="submit" name="draf" value="save as draft" class="btn">
						</div>
					</form>
				</div>
			</div>
